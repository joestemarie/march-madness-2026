...
oriented as (
    -- Orient so team_a is the higher seed (lower number)
    -- If same seed, alphabetical by canonical name
    select
        season,
        round,
        case
        ...
        -- team_a_won: 1 if the higher-seeded team (team_a) won
        case
